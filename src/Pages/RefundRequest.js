...
const RefundRequestTable = () => {
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      {/* Page Title */}
      <h1 className="text-2xl font-semibold text-gray-800 mb-4">Refund Request</h1>
        ...
        <table className="min-w-full bg-white border border-gray-200">
          ...
          <thead>
            <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
              ...
              <th className="py-3 px-4 text-left border-b">Pending</th>
              <th className="py-3 px-4 text-left border-b">Approve</th>
              <th className="py-3 px-4 text-left border-b">Reject</th>
