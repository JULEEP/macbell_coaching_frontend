          ...
          <div className="overflow-x-auto">
            <table className="min-w-full table-auto border-collapse">
              ...
              <tbody>
                {/* Sample Data Row */}
                <tr>
                  <td className="px-4 py-2 text-gray-600">Syllabus 1</td>
                  <td className="px-4 py-2 text-gray-600">Theory</td>
                  <td className="px-4 py-2 text-gray-600">12-Dec-24</td>
                  <td className="px-4 py-2 text-gray-600">All Students</td>
                  <td className="px-4 py-2 text-gray-600">Math syllabus for the first term.</td>
