  ...
  return (
    <div className="min-h-screen flex bg-gray-100">
      ...
      <div className="flex-grow p-6">      {/* Page Title */}
        <h1 className="text-sm font-semibold text-blue-500 mb-6">
          Student Details
        </h1>
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <p className="text-sm text-purple-400">Mr. Rahman</p>
                  </div>
                  <hr className="my-2 border-gray-300" />
                  <div className="flex justify-between">
                    <p className="text-sm text-gray-400">Father's Occupation:</p>
                    <p className="text-sm text-purple-400">Engineer</p>
                  </div>
                  <hr className="my-2 border-gray-300" />
                  <div className="flex justify-between">
                    <p className="text-sm text-gray-400">Mother's Name:</p>
                    <p className="text-sm text-purple-400">Mrs. Rahman</p>
                  </div>
                  <hr className="my-2 border-gray-300" />
                  <div className="flex justify-between">
                    <p className="text-sm text-gray-400">Mother's Occupation:</p>
                    <p className="text-sm text-purple-400">Teacher</p>
                  </div>
                  <hr className="my-2 border-gray-300" />
                  <div className="flex justify-between">
                    <p className="text-sm text-gray-400">Contact Number:</p>
                    <p className="text-sm text-purple-400">+88098765432</p>
                  </div>
                  <hr className="my-2 border-gray-300" />
                </div>
              </div>
